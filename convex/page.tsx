...
function OrderChat({ orderId, currentUserId }: { orderId: Id<"orders">, currentUserId?: string }) {
...
export default function OrdersPage() {
  ...
  const handleVerify = async (orderId: any) => {
  ...
  const handleUpdateMeetingPoint = async (orderId: any) => {
                  ...
                  <div className="bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
                    {order.role === "seller" ? (
                      <div className="text-center">
                        ...
                        <p className="text-[10px] text-emerald-600 mt-2 italic">הקונה יסרוק/יזין קוד זה בזמן המפגש</p>
                      </div>
                    ) : (
